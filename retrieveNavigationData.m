function [satdata, ionodata] = ...
      retrieveNavigationData(gpsWeek, gpsSec, utcTime, ephemHourOffset, navDirectory)
...
satsTable = struct2table(satdata);
writetable(satsTable, [navDirectory '/gpsW_SOW_' num2str(gpsWeek) '_' num2str(gpsSec) '_navData.csv']);